...
const header = (current = "blog") => `
  <header class="site-header">
    ...
    <nav class="site-nav" id="site-nav"><a href="/sandbox/index.html">Home</a><a href="/about.html">About</a><a href="/services.html">Services</a><a href="/sandbox/index.html#service-area">Service Area</a><a href="/sandbox/blog.html"${current === "blog" ? ' aria-current="page"' : ""}>Blog</a><a href="/faq.html">FAQ</a><a class="nav-call" href="tel:+17074139366">(707) 413-9366</a><a class="nav-cta" href="/sandbox/index.html#contact-form">Check Availability</a></nav>
  </header>`;

const fallbackFooter = `
  <footer class="site-footer"><div class="footer-shell"><div class="footer-bar"><p>Mobile Cryo Pro sandbox preview</p><div class="footer-links"><a href="/sandbox/index.html">Home</a><a href="/services.html">Services</a><a href="/sandbox/blog.html">Blog</a><a href="/faq.html">FAQ</a></div></div></div></footer>`;
...
const articlePage = (article) => {
  ...
  const schema = {
    ...
    author: { "@type": "Organization", name: "Mobile Cryo Pro Editorial Team" },
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Blog", item: "https://mobilecryopro.com/sandbox/blog.html" },
...
<html lang="en" data-sandbox-preview="true"><head>
  ...
  <main id="main-content" tabindex="-1"><article class="article-shell evidence-article-shell">
    ...
    <div class="article-layout"><aside class="article-sidebar evidence-sidebar"><p class="panel-label">Quick note</p><p>General education, not medical advice or a promise of results. Personal concerns belong with an appropriately licensed professional.</p><nav aria-label="On this page"><strong>In this guide</strong><ol>${article.sections.map((section, index) => `<li><a href="#section-${index + 1}">${esc(section.heading)}</a></li>`).join("")}</ol></nav><a class="button button-secondary" href="/services.html">See services & pricing</a></aside>
      ...
      <aside class="article-conversion"><p class="eyebrow">A practical next step</p><h2>Ask Dan about your location and goal.</h2><p>Share the service or area you are considering, your city, and your preferred timing. Dan can confirm current options without turning a general article into personal medical advice.</p><div class="article-conversion-actions"><a class="button button-primary" href="/sandbox/index.html#contact-form">Check availability</a><a class="button button-secondary" href="/services.html">See services & pricing</a></div></aside>
      ...
      <aside class="article-review-status"><strong>Editorial status</strong><p>${esc(article.status)}. This draft does not claim medical or veterinary review. Exact equipment, operating protocols, screening language, and Dan's preferred author role remain pending confirmation.</p></aside></div>
    </div></article>
  ...
  </main>${fallbackFooter}</div><script src="/sandbox/footer.js?v=2"></script><script src="/sandbox/script.js?v=25"></script></body></html>`);
};
...
<aside class="blog-trust-strip"><div><p class="eyebrow">Our standard</p><h2>Useful first. Accurate always.</h2><p>We use primary research and high-quality reviews where science is relevant, distinguish one cooling method from another, and leave unsupported outcomes out.</p></div><a class="text-link" href="/sandbox/evidence.html">How we research these guides</a></aside></main>${fallbackFooter}</div><script src="/sandbox/blog-filter.js?v=1"></script><script src="/sandbox/footer.js?v=2"></script><script src="/sandbox/script.js?v=25"></script></body></html>`);

fs.mkdirSync(guideDir, { recursive: true });
for (const article of articles) fs.writeFileSync(path.join(guideDir, `${article.slug}.html`), articlePage(article));
fs.writeFileSync(path.join(sandboxDir, "blog.html"), hub);
console.log(`Built ${articles.length} static sandbox guides and the blog hub.`);
