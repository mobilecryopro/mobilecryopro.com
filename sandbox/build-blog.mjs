...
const header = (current = "guides") => `
  <header class="site-header">
    ...
    <nav class="site-nav" id="site-nav"><a href="/sandbox/index.html">Home</a><a href="/sandbox/about.html">About</a><a href="/sandbox/services.html">Services</a><a href="/sandbox/index.html#service-area">Service Area</a><a href="/sandbox/guides/index.html"${current === "guides" ? ' aria-current="page"' : ""}>Guides</a><a href="/faq.html">FAQ</a><a class="nav-call" href="tel:+17074139366">(707) 413-9366</a><a class="nav-cta" href="/sandbox/index.html#contact-form">Check Availability</a></nav>
  </header>`;

const fallbackFooter = `
  <footer class="site-footer"><div class="footer-shell"><div class="footer-bar"><p>Mobile Cryo Pro sandbox preview</p><div class="footer-links"><a href="/sandbox/index.html">Home</a><a href="/sandbox/services.html">Services</a><a href="/sandbox/guides/index.html">Guides</a><a href="/faq.html">FAQ</a></div></div></div></footer>`;
...
const sourceList = (article) => {
  if (!article.refs.length) {
    const contextLink = article.slug === "equine-barn-visit" ? "/equine-cryotherapy.html" : "/sandbox/services.html";
    return `<p>This guide uses Mobile Cryo Pro service information. Confirm appointment details before booking.</p><ul class="reference-list"><li><a href="${contextLink}">Mobile Cryo Pro services and pricing</a></li><li><a href="/faq.html">Mobile Cryo Pro frequently asked questions</a></li></ul>`;
  }
...
<html lang="en" data-sandbox-preview="true"><head>
  ...
  <main id="main-content" tabindex="-1"><article class="article-shell evidence-article-shell">
    ...
    <div class="article-layout"><aside class="article-sidebar evidence-sidebar"><p class="panel-label">Quick note</p><p>General education, not medical advice or a promise of results. Personal concerns belong with an appropriately licensed professional.</p><nav aria-label="On this page"><strong>In this guide</strong><ol>${article.sections.map((section, index) => `<li><a href="#section-${index + 1}">${esc(section.heading)}</a></li>`).join("")}</ol></nav><a class="button button-secondary" href="/sandbox/services.html">See services & pricing</a></aside>
      ...
      <aside class="article-conversion"><p class="eyebrow">Questions about a service?</p><h2>Talk with Dan before you book</h2><p>Share the service, your location, and your questions. Dan will confirm options and availability.</p><div class="article-conversion-actions"><a class="button button-primary" href="/sandbox/index.html#contact-form">Check availability</a><a class="button button-secondary" href="/sandbox/services.html">See services & pricing</a></div></aside>
  ...
  </main>${fallbackFooter}</div><script src="/sandbox/footer.js?v=14"></script><script src="/sandbox/script.js?v=25"></script></body></html>`);
};
...
<main id="main-content" tabindex="-1"><section class="blog-hero-panel evidence-hero"><div class="blog-hero-copy"><p class="eyebrow">Mobile Cryo Pro resources</p><h1>Cryotherapy guides for real life</h1><p>Practical guides to localized cryotherapy, CryoSkin, mobile appointments, and choosing the right service for your goals.</p><div class="blog-hero-actions"><a class="button button-primary" href="#all-guides">Explore the guides</a><a class="text-link" href="/sandbox/services.html">See services & pricing</a></div></div></section>
